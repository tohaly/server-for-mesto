module.exports.validOption = {
  ...
  urlMessage: '— не правильным форматом для url-адреса',
  emailMessage: '— не прафильный формат для email-адреса',
  minPasswordLength: [8, 'Минимальная длинна пароля 8 символов']
};
